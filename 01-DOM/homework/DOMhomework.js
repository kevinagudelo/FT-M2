...
var ident = document.querySelector("#createdBy")
ident.innerHTML = "Aplicacion creada por Kevin"
...
function addToDo() {
  ...
  var element = new ToDo(input.value)
...
function completeToDo(event) {
  ...
  var nuevoElemento = new ToDo(toDoItems[index].description)
  nuevoElemento.completeToDo()
  toDoItems[index]= nuevoElemento
